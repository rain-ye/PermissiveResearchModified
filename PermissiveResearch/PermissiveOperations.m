...
- (void)main
{
    @autoreleasepool {
        ...
        //Sorting
        if ([PermissiveResearchDatabase sharedDatabase].elements.count > 3000) {
            findedElements = [[[PermissiveResearchDatabase sharedDatabase].elements sortedArrayUsingDescriptors:@[sortDescriptor]] subarrayWithRange:NSMakeRange(0, 3000)];
        } else {
...
- (void)main
{
    @autoreleasepool {
        ...
        NSArray *findedElements;
        if (arrayOfElemets.count > 3000) {
            findedElements = [[arrayOfElemets sortedArrayUsingDescriptors:@[sortDescriptor]] subarrayWithRange:NSMakeRange(0, 3000)];
        } else {
